...
class CornerNet_Squeeze(Base):
    def __init__(self):
        ...
        model_path = get_file_path("..", "cache", "nnet", "CornerNet_Squeeze", "CornerNet_Squeeze_15000.pkl")
...
class CornerNet_Saccade(Base):
    def __init__(self):
        ...
        model_path = get_file_path("..", "cache", "nnet", "CornerNet_Saccade", "CornerNet_Saccade_10000.pkl")
